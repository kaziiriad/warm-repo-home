...
import { Shield, Rocket, TrendingUp, Zap } from "lucide-react";
    ...
    <section id="about" className="py-24">
      <div className="section-container">
        ...
        >
          ...
          >
            Built production-grade systems with complete CI/CD pipelines, including an ML-enhanced 
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              ...
              <div className="flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Full CI/CD pipelines with automated deployments, monitoring
                  </p>
                </div>
              </div>
              <div className="flex items-start gap-3">
